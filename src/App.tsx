...
type NavKey = 'start' | 'services' | 'expert' | 'gallery' | 'process' | 'contact';
type ServiceKey =
  | 'liability'
  | 'estimates'
  | 'inspection'
...
const translations: Record<Language, Translation> = {
  pl: {
    ...
    form: {
      ...
      consent:
        'Zapoznałem/am się z informacją o przetwarzaniu danych osobowych zawartą w',
  ...
  en: {
    ...
    form: {
      ...
      consent:
        'I have read the information about the processing of personal data contained in the',
      submit: 'Send report',
      sending: 'Sending...',
...
function MainSite() {
  ...
  const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    window.location.href = `mailto:ensure.serwis@gmail.com?subject=${subject}&body=${body}`;
    ...
    <div className="min-h-screen bg-[#f5f9fd] font-sans text-[#142129]">
      ...
      <main>
        <section id="start" className="relative flex min-h-screen items-center overflow-hidden bg-[#0c171f] pt-24 text-white">
          <div className="animate-image-drift absolute inset-0 bg-cover bg-center opacity-46" style={{ backgroundImage: "url('/images/ensure-damage-scene.jpg')" }} />
              ...
              <label className="mt-6 flex cursor-pointer items-start gap-3">
                ...
                <span className="text-xs leading-5 text-white/70">
                  ...
                  <a
                    ...
                    className="font-bold text-[#35c8ff] underline decoration-[#35c8ff]/60 underline-offset-2 transition hover:text-white"
                  >
      ...
      <footer className="bg-[#101820] py-10 text-white">
        <div className="mx-auto flex max-w-7xl flex-col gap-6 px-5 lg:flex-row lg:items-center lg:justify-between lg:px-8">
          ...
          <div className="text-sm leading-7 text-white/60 lg:text-right">
            ...
            <a href="#polityka-prywatnosci" className="mt-2 inline-block text-white/75 underline decoration-[#35c8ff] underline-offset-4 transition hover:text-[#35c8ff]">
...
function PrivacyPolicy() {
  useEffect(() => {
    ...
    document.title = 'Polityka prywatności | Ensure-Serwis';
    document.documentElement.lang = 'pl';
  }, []);

  return (
    <div className="min-h-screen bg-[#f5f9fd] font-sans text-[#142129]">
      <header className="border-b border-white/10 bg-[#111c24] text-white">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-6 px-5 py-5 lg:px-8">
          <a href="#start" className="block">
            <span className="block font-display text-2xl font-bold uppercase leading-none tracking-[0.08em]">Ensure-Serwis</span>
            <span className="mt-1 block text-xs font-semibold uppercase tracking-[0.24em] text-[#35c8ff]">Mateusz Radzikowski</span>
          </a>
          <a href="#start" className="inline-flex items-center gap-2 border border-[#35c8ff]/60 px-4 py-3 text-sm font-black uppercase tracking-[0.12em] transition hover:bg-[#35c8ff] hover:text-[#111c24]">
      ...
      <main>
        <section className="relative overflow-hidden bg-[#111c24] py-20 text-white">
          <div className="gold-ambient absolute inset-0" />
          <div className="relative mx-auto max-w-6xl px-5 lg:px-8">
            <p className="text-sm font-black uppercase tracking-[0.32em] text-[#ffcf78]">Ochrona danych osobowych</p>
            <h1 className="mt-4 max-w-4xl font-display text-5xl font-bold uppercase leading-none tracking-[0.04em] sm:text-7xl">Polityka prywatności</h1>
            <p className="mt-7 max-w-3xl text-lg leading-8 text-white/75">
              Poniżej opisujemy, jakie informacje mogą być przetwarzane podczas korzystania ze strony Ensure-Serwis, kontaktowania się z nami oraz korzystania z odnośników do usług zewnętrznych.
            </p>
            <p className="mt-4 text-sm font-semibold uppercase tracking-[0.14em] text-[#35c8ff]">Ostatnia aktualizacja: 25 sierpnia 2026 r.</p>
          </div>
        </section>

        <section className="py-20">
          <div className="mx-auto max-w-6xl space-y-14 px-5 lg:px-8">
            <PolicySection title="Administrator danych">
              <p>
                Za dane przekazane w związku z korzystaniem z serwisu odpowiada Ensure-Serwis Mateusz Radzikowski, ul. Romanówka 7/5, 08-110 Siedlce, NIP: PL8212668971, REGON: 386889448. W sprawach dotyczących prywatności można skontaktować się z nami pod adresem ensure.serwis@gmail.com lub telefonicznie pod numerem 729 979 400.
              </p>
            </PolicySection>

            <PolicySection title="Dlaczego i na jakiej podstawie korzystamy z danych">
              <div className="overflow-x-auto border border-[#ccdbe5] bg-white">
                <table className="w-full min-w-[720px] border-collapse text-left">
                  <thead className="bg-[#142129] text-white">
                    <tr>
                      <th className="p-4">Cel</th>
                      <th className="p-4">Podstawa prawna</th>
                      <th className="p-4">Dane i źródło</th>
                      <th className="p-4">Retencja</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr className="align-top">
                      <td className="border-t border-[#ccdbe5] p-4">Odpowiedź na zapytanie, wstępna analiza szkody i uzgodnienie zakresu usługi</td>
                      <td className="border-t border-[#ccdbe5] p-4">Art. 6 ust. 1 lit. f RODO – nasz uzasadniony interes polegający na prowadzeniu komunikacji; jeżeli kontakt zmierza do zawarcia umowy, również art. 6 ust. 1 lit. b RODO</td>
                      <td className="border-t border-[#ccdbe5] p-4">Dane podane przez użytkownika: imię i nazwisko, telefon, e-mail, miejscowość, informacje o pojeździe, rodzaj sprawy oraz opis zdarzenia</td>
                      <td className="border-t border-[#ccdbe5] p-4">Przez czas prowadzenia rozmów lub realizacji sprawy, a później do upływu terminów przedawnienia roszczeń albo okresu wymaganego przepisami</td>
                    </tr>
                    <tr className="align-top">
                      <td className="border-t border-[#ccdbe5] p-4">Zapewnienie bezpieczeństwa i prawidłowego działania witryny</td>
                      <td className="border-t border-[#ccdbe5] p-4">Art. 6 ust. 1 lit. f RODO – ochrona serwisu, wykrywanie błędów i nadużyć</td>
                      <td className="border-t border-[#ccdbe5] p-4">Adres IP, data i czas połączenia, rodzaj przeglądarki, informacje techniczne oraz logi żądań</td>
                      <td className="border-t border-[#ccdbe5] p-4">Przez okres wynikający z ustawień i zasad dostawcy hostingu, nie dłużej niż jest to potrzebne do celów bezpieczeństwa</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <PolicySection title="Komu dane mogą zostać udostępnione">
              <p className="mb-5">Nie sprzedajemy danych użytkowników. Dostęp mogą uzyskać wyłącznie podmioty, które są potrzebne do utrzymania serwisu lub obsługi konkretnej sprawy, w szczególności:</p>
              <PolicyList items={[
                'Cloudflare – dostawca hostingu, zabezpieczeń i infrastruktury sieciowej strony',
                'operatorzy poczty elektronicznej i usług telekomunikacyjnych',
                'dostawcy wsparcia informatycznego, serwisu i utrzymania strony',
                'podmioty księgowe, prawne, ubezpieczeniowe, rzeczoznawcy lub warsztaty – wyłącznie wtedy, gdy wymaga tego prowadzona sprawa albo obowiązek prawny',
              ]} />
            </PolicySection>

            <PolicySection title="Kontakt przez formularz">
              <p>
                Formularz dostępny na stronie pomaga przygotować wiadomość dotyczącą szkody lub innego zapytania. W aktualnej wersji serwisu po jego zatwierdzeniu uruchamiany jest program pocztowy użytkownika z uzupełnioną treścią. Wiadomość zostaje wysłana dopiero po potwierdzeniu jej wysyłki w tym programie. Dane wpisane w formularzu nie są przechowywane przez stronę we własnej bazie danych. Ich podanie jest dobrowolne, jednak bez podstawowych danych kontaktowych nie będziemy mogli odpowiedzieć ani zająć się zgłoszeniem.
              </p>
            </PolicySection>

            <PolicySection title="Narzędzia i serwisy zewnętrzne">
              <p className="mb-5">Na stronie znajdują się elementy lub odnośniki prowadzące do usług innych dostawców. Po skorzystaniu z nich dostawca może otrzymać m.in. adres IP oraz dane techniczne urządzenia:</p>
              <PolicyList items={[
                'OpenStreetMap – wyświetlanie mapy lokalizacji firmy',
                'Google Maps – otwarcie wskazówek dojazdu po kliknięciu adresu',
                'WhatsApp, Facebook oraz operator poczty elektronicznej – kontakt i komunikacja',
                'Google Fonts – pobieranie krojów pisma użytych w wyglądzie strony',
                'Google Analytics i Google Ads – wyłącznie jeśli zostaną uruchomione: statystyka ruchu, pomiar skuteczności reklam, konwersje i remarketing',
              ]} />
              <p className="mt-5 text-sm text-[#65737d]">Każdy zewnętrzny dostawca działa zgodnie z własnymi zasadami prywatności. Jeżeli w przyszłości uruchomimy narzędzia analityczne lub reklamowe wymagające zgody, zostaną one aktywowane dopiero po dokonaniu odpowiedniego wyboru przez użytkownika.</p>
            </PolicySection>

            <PolicySection title="Twoje prawa">
              <p>
                Osoba, której dane przetwarzamy, może – w zakresie przewidzianym przez RODO – zażądać dostępu do danych i otrzymania ich kopii, poprawienia nieprawidłowych informacji, usunięcia danych albo ograniczenia ich wykorzystywania. W określonych przypadkach można także skorzystać z prawa do przenoszenia danych. Jeżeli podstawą przetwarzania jest nasz prawnie uzasadniony interes, można wnieść sprzeciw. Zgodę, jeśli została udzielona, można odwołać w dowolnej chwili; nie wpływa to na legalność działań wykonanych przed jej wycofaniem. W celu realizacji praw należy napisać na ensure.serwis@gmail.com.
              </p>
            </PolicySection>

            <PolicySection title="Przekazywanie danych poza Europejski Obszar Gospodarczy">
              <p>
                Niektórzy dostawcy technologii, w szczególności Google, Meta (Facebook i WhatsApp) lub Cloudflare, mogą przetwarzać informacje przy wykorzystaniu infrastruktury znajdującej się poza Europejskim Obszarem Gospodarczym. W takich sytuacjach transfer odbywa się na zasadach przewidzianych w RODO, np. na podstawie decyzji stwierdzającej odpowiedni poziom ochrony lub standardowych klauzul umownych.
              </p>
            </PolicySection>

            <PolicySection title="Bezpieczeństwo i decyzje automatyczne">
              <p>
                Stosujemy rozwiązania organizacyjne i techniczne adekwatne do charakteru serwisu, w tym szyfrowane połączenie HTTPS oraz zabezpieczenia infrastruktury Cloudflare. Dane przekazywane przez stronę nie służą do podejmowania wobec użytkownika decyzji opartych wyłącznie na automatycznym przetwarzaniu ani do profilowania wywołującego skutki prawne.
              </p>
            </PolicySection>

            <PolicySection title="Prawo złożenia skargi">
              <p>
                Jeżeli uznasz, że dane są przetwarzane niezgodnie z przepisami, możesz skierować skargę do Prezesa Urzędu Ochrony Danych Osobowych. Dane kontaktowe organu znajdują się na stronie uodo.gov.pl.
              </p>
            </PolicySection>

            <PolicySection title="Zmiany dokumentu">
              <p>
                Polityka może być aktualizowana, gdy zmienią się funkcje strony, wykorzystywani dostawcy albo wymagania prawne. Obowiązująca wersja jest zawsze publikowana w tym miejscu wraz z datą ostatniej aktualizacji.
              </p>
            </PolicySection>
          </div>
        </section>
      ...
      <footer className="bg-[#101820] py-8 text-white">
        <div className="mx-auto flex max-w-6xl flex-col gap-3 px-5 text-sm text-white/65 sm:flex-row sm:items-center sm:justify-between lg:px-8">
          <span>Ensure-Serwis Mateusz Radzikowski</span>
          <a href="#start" className="text-[#35c8ff] transition hover:text-white">Wróć do strony głównej</a>
        </div>
      </footer>
    </div>
  );
...
function PolicySection({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <section className="border-t-4 border-[#1e9dde] pt-7">
      <h2 className="font-display text-3xl font-bold uppercase tracking-[0.04em] text-[#111c24] sm:text-4xl">{title}</h2>
      <div className="mt-5 text-base leading-8 text-[#4b5a64]">{children}</div>
    </section>
  );
}
...
function App() {
  const [isPrivacyPolicy, setIsPrivacyPolicy] = useState(() => window.location.hash === '#polityka-prywatnosci');

  useEffect(() => {
    const handleHashChange = () => setIsPrivacyPolicy(window.location.hash === '#polityka-prywatnosci');
    window.addEventListener('hashchange', handleHashChange);
    return () => window.removeEventListener('hashchange', handleHashChange);
  }, []);

  return isPrivacyPolicy ? <PrivacyPolicy /> : <MainSite />;
}
