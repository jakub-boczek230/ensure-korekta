...
const translations: Record<Language, Translation> = {
  ...
  en: {
    ...
    form: {
      ...
      consent:
        'I consent to the processing of my personal data in accordance with the data protection regulations in connection with submitting an enquiry through the contact form. Providing data is voluntary but necessary to process the enquiry. I have been informed that I have the right to access my data, correct it and request that its processing be stopped. The data controller is Ensure-Serwis Mateusz Radzikowski, Romanówka 7/5, 08-110 Siedlce, NIP: PL8212668971, REGON: 386889448.',
      submit: 'Send report',
      sending: 'Sending...',
              ...
              <label className="mt-6 flex cursor-pointer items-start gap-3">
                ...
                <span className="text-xs leading-5 text-white/70">
                  ...
                  <a
                    ...
                    className="font-bold text-[#35c8ff] underline underline-offset-2 hover:text-white"
                  >
                    {t.footer.privacy}
                  </a>
                </span>
